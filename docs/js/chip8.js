...
* @returns {Uint32Array}
*/
export function get_display_memory() {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.get_display_memory(retptr);
...
* @returns {string}
*/
export function get_current_opcode() {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.get_current_opcode(retptr);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
...
* @param {Uint8Array} data
*/
export function set_keys_states(data) {
    const ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    wasm.set_keys_states(ptr0, len0);
}
