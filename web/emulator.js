...
class Emulator {
    ...
    constructor(terminal, games) {
        ...
        // this.menuOption = 0;
        // this.menuSubStates = [this.selectGameState, this.settingsState];
        this.mainCycle = null;
        ...
        this.preloadGames = games;
        this.gameOption = 0;        
        this.mainMenu = new MainMenuState(this.terminal);
    ...
    onKeyDown(key) {
        switch (key) {
            case "Escape":
                this.state.escHandler();
                break;
            case "ArrowDown":
                this.state.keyDownHandler();
                break;
            case "ArrowUp":
                this.state.keyUpHandler();
                break;
            case "Enter":
